...
export function UserScorecardDrawer({ scorecard, isOpen, onClose }: UserScorecardDrawerProps) {
              ...
              <div className="border border-gray-200 rounded-xl p-2">
                ...
                <CardContent className="space-y-4">
                  <div className="text-center">
                    <div className={`text-4xl ${getScoreColor(scorecard.overallScore)}`}>
                    ...
                    <div className="flex justify-center gap-2 mt-2">
                      ...
                      <Badge className={getRoleColor(scorecard.role)}>
                        ...
                        <span className="ml-1 capitalize">{scorecard.role}</span>
                      </Badge>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <div className="text-2xl text-blue-600">{scorecard.activityMetrics.totalActivities}</div>
                      <div className="text-sm text-gray-600">Total Activities</div>
                    </div>
                    <div className="text-center p-3 bg-green-50 rounded-lg">
                      <div className="text-2xl  text-green-600">{scorecard.activityMetrics.proactiveActions}</div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm ">{scorecard.activityMetrics.engagementScore}/100</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div className="p-3 bg-purple-50 rounded-lg">
                      <div className="text-lg  text-purple-600">{scorecard.activityMetrics.averageLogFrequency}</div>
                      <div className="text-xs text-gray-600">Log Frequency</div>
                    </div>
                    <div className="p-3 bg-orange-50 rounded-lg">
                      <div className="text-lg  text-orange-600">{scorecard.activityMetrics.averageResponseTime}</div>
