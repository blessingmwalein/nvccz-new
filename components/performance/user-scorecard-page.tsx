...
import { CiUser, CiViewBoard, CiCircleCheck, CiRedo, CiTrophy } from "react-icons/ci"
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-balance">My Performance Scorecard</h1>
          <p className="text-muted-foreground font-normal mt-1">
            Track your individual performance, goals, and task completion
          </p>
        </div>
